...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
library("GPArotation")
test.fa <- fa(r=test.cor$correlations,nfactors=test.parallel$nfact)
test.fa
```
...
Grice (2001) suggests researchers examine the degree of indeterminacy in their factor solutions using three different measures: (1) validity – evidence of correlational relationships between factor scores and factor(s); (2) univocality- the extent to which factor scores are adequately or insufficiently correlated with other factors in the same analysis; and (3) correlational accuracy – which reports the extent to which correlations among the estimated factor scores match the correlations among the factors themselves. 
